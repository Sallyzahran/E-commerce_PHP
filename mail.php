...
try {
    ...
    $mail->Username   = 'sallyzahran23@outlook.com';                     //SMTP username
    $mail->Password   = '1234567890Sa';                               //SMTP password
    $mail->SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS;            //Enable implicit TLS encryption
    $mail->Port       = 587;                                    //TCP port to connect to; use 587 if you have set `SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS`

    //Recipients
    $mail->setFrom('sallyzahran23@outlook.com','Ecommerce');
    $mail->addAddress('sallyzahran.sz@gmail.com');     //Add a recipient
